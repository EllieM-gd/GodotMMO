...
@export_range(0.1, 10.0, 0.1) var zoom: float = 4.0 # 4.0 zoom level is 75% zoomed in compared to 1.0
...
func _load_default_icons():
	var base_path = "Addons/addons/dynamic_minimap/icons/default/"
...
func _world_to_minimap(world_pos: Vector2):
	...
	var scale = (radius / world_scale) * zoom
